...
class TestRectangle_init(unittest.TestCase):
    """Unittests for initialize a Rectangle"""
...
class TestRectangle_width(unittest.TestCase):
    """Unittests for Rectangle width attribute."""
...
class TestRectangle_order_of_init(unittest.TestCase):
    """Unittests for Rectangle order of attribute init"""
...
class TestRectangle_area(unittest.TestCase):
    """Unittests for area method of the Rectangle"""
